[![AppVeyor](https://img.shields.io/docker/cloud/build/txscience/fuse-provider-immunespace?style=plastic)](https://hub.docker.com/repository/docker/txscience/fuse-provider-immunespace/builds)
